...
|Fifth|2026.9.7|$D_4$ <br> $\text{Hailtonian system}$| $\mathrm{I.}$ Find and learned the paper.<br> $\mathrm{II.}$ apply what you learned and genralize to the Hamiltonian system|[Click Me!](https://github.com/Jason-TongR/Ilya-Project/releases/tag/%E7%AC%AC%E4%BA%94%E6%AC%A1%E7%BB%84%E4%BC%9A)|
|Sixth|2026.9.14|$\mathrm{I.}\text{Bifurcation diagram in }B_1=1,B_2=0$ <br> $\mathrm{II.}\text{Cubic form}$|$\text{Determine how each parts looks like in bifurcation diagram}$|[Click Me!](https://github.com/Jason-TongR/Ilya-Project/releases/tag/%E7%AC%AC%E5%85%AD%E6%AC%A1%E7%BB%84%E4%BC%9A)|
******
>[!Note]
>**Some notes:**
